...
Gem::Specification.new do |spec|
  ...
  spec.homepage    = 'https://github.com/xoengineering/flickarr'
  spec.license     = 'MIT'

  spec.required_ruby_version = '>= 4.0.0'

  spec.metadata['homepage_uri']    = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/xoengineering/flickarr'
  spec.metadata['changelog_uri']   = 'https://github.com/xoengineering/flickarr/blob/main/CHANGELOG.md'
  ...
  spec.files = IO.popen(%w[git ls-files -z], chdir: __dir__, err: IO::NULL) do |ls|
    ls.readlines("\x0", chomp: true)
      .reject { it == gemspec }
      .reject { it.start_with?(*%w[bin/ Gemfile .gitignore .rspec spec/ .github/ .rubocop.yml]) }
  end
